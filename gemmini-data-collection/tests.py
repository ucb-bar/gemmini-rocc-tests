...
tests = [
    GemminiTest(["DIM_I", "DIM_J", "DIM_K"], ["128", "256", "64"], "tiled_matmul_ws_perf_template", "tiled_matmul_ws_perf-128_256_64"),

    GemminiTest(["IN_DIM", "IN_CHANNELS", "OUT_CHANNELS", "KERNEL_DIM", "STRIDE", "PADDING"], ["224", "3", "64", "7", "2", "3"], "conv-perf_template", "conv-perf_224-3-64-7-2-3"),
]
