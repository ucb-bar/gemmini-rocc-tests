...
#ifndef BAREMETAL
uint64_t* alexnet_function_1(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_alex){
#else
uint64_t* alexnet_function_1(int cid, int orow_divide, int batch_divide, int target_util){
#endif
