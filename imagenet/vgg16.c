...
int main (int argc, char * argv[]) {
    ...
    start = read_cycles();
    printf("Layer with I=%i, K=%i and J=%i\n", fc_14_params.I, fc_14_params.K, fc_14_params.J);

    tiled_matmul_nn_auto(fc_14_params.I, fc_14_params.J, fc_14_params.K,
        conv_13_out, fc_14_w, fc_14_b, fc_14_out,
        RELU, 1, true, 
        tiled_matmul_type, check, "fc14");
