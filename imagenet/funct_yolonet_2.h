...
#ifndef BAREMETAL
uint64_t* yolonet_function_2(size_t cid, size_t group_id, bool part1, bool part2, bool part3, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_yolo2){
#else
uint64_t* yolonet_function_2(size_t cid, size_t group_id, bool part1, bool part2, bool part3, int orow_divide, int batch_divide, int target_util){
#endif
  ...
  static uint64_t cycles[NUM_CORE][num_cycle];
    ...
    if(part1){
      ...
      tiled_conv_A_stride_auto_stride(
          ...
          (elem_t*)image2_s, (elem_t*)conv_1_w_yolo2, (acc_t*)conv_1_b_yolo2, (elem_t*)conv_1_out_yolo2,
...
uint64_t* yolonet_block_function_2(size_t cid, size_t group_id, bool part1, bool part2, bool part3, int orow_divide, int batch_divide, int target_util){
#define num_cycle (19+5+3)
