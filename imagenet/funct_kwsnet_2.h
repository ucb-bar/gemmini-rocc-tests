...
#ifndef BAREMETAL
uint64_t* kwsnet_function_2(size_t cid, size_t group_id, bool part1, bool part2, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_kws2){
#else
uint64_t* kwsnet_function_2(size_t cid, size_t group_id, bool part1, bool part2, int orow_divide, int batch_divide, int target_util){
#endif
...
//printf("kws part1: %d, kws part2: %d\n", part1, part2);
    if(part1){
      ...
      tiled_conv_A_stride_auto_stride(
          ...
          (elem_t*)fingerprints_2, (elem_t*)conv_1_w_kws2, (acc_t*)conv_1_b_kws2, (elem_t*)conv_1_out_kws2_pooled, //conv_1_out_kws2,
...
uint64_t* kwsnet_block_function_2(size_t cid, size_t group_id, bool part1, bool part2, int orow_divide, int batch_divide, int target_util){
#define num_cycle (25+1+11+4)
