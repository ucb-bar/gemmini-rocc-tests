...
#ifndef BAREMETAL
uint64_t* resnet_function_4(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_res){
#else
uint64_t* resnet_function_4(int cid, int orow_divide, int batch_divide, int target_util){
#endif
...
//printf("Address of end for cid %d: %p\n", cid, &end);
    ...
    tiled_conv_A_stride_auto_cid(
        ...
        (elem_t*)images_4, (elem_t*)conv_1_w_res4, (acc_t*)conv_1_b_res4, (elem_t*)conv_1_out_res4_pooled,
