...
#if debug_print == 1
    	printf("rid: %d, workload id: %d, queue id: %d,  status: %d, score: %llu, others score: %llu, slack: %llu \n", real_cid, workload_id, queue_id, total_queue_status[queue_id], gemmini_planaria_score[total_sub_group_id], gemmini_planaria_score[other_total_sub_group_id], slack);
...
#if debug_print == 1
              printf("hack rid: %d, workload id: %d, queue id: %d finished - status: %d\n", real_cid, workload_id, queue_id, total_queue_status[queue_id]);
#endif 
              gemmini_terminate_receive[total_sub_group_id] = false;
              gemmini_terminate[total_sub_group_id] = false;
