...
#ifndef BAREMETAL
uint64_t* resnet_function_1(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_res){
#else
uint64_t* resnet_function_1(int cid, int orow_divide, int batch_divide, int target_util){
#endif
