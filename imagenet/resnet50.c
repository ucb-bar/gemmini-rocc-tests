...
int main (int argc, char * argv[]) {
    ...
    for (int i = 0; i < fc_54_params.batch_size; i++) {
        if (preds[i] != correct[i] && fc_54_out[preds[i]][i] != fc_54_out[correct[i]][i]) {
