    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_3_params.stride, 1, 1, conv_3_params.padding, conv_3_params.kernel_size, conv_3_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_7_params.stride, 1, 1, conv_7_params.padding, conv_7_params.kernel_size, conv_7_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_10_params.stride, 1, 1, conv_10_params.padding, conv_10_params.kernel_size, conv_10_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_13_params.stride, 1, 1, conv_13_params.padding, conv_13_params.kernel_size, conv_13_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_17_params.stride, 1, 1, conv_17_params.padding, conv_17_params.kernel_size, conv_17_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_20_params.stride, 1, 1, conv_20_params.padding, conv_20_params.kernel_size, conv_20_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_23_params.stride, 1, 1, conv_23_params.padding, conv_23_params.kernel_size, conv_23_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_26_params.stride, 1, 1, conv_26_params.padding, conv_26_params.kernel_size, conv_26_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_30_params.stride, 1, 1, conv_30_params.padding, conv_30_params.kernel_size, conv_30_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_33_params.stride, 1, 1, conv_33_params.padding, conv_33_params.kernel_size, conv_33_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_36_params.stride, 1, 1, conv_36_params.padding, conv_36_params.kernel_size, conv_36_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_39_params.stride, 1, 1, conv_39_params.padding, conv_39_params.kernel_size, conv_39_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_42_params.stride, 1, 1, conv_42_params.padding, conv_42_params.kernel_size, conv_42_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_45_params.stride, 1, 1, conv_45_params.padding, conv_45_params.kernel_size, conv_45_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_47_params.stride, 1, 1, conv_47_params.padding, conv_47_params.kernel_size, conv_47_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_49_params.stride, 1, 1, conv_49_params.padding, conv_49_params.kernel_size, conv_49_params.kernel_size,
            false, false, false, false, false,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_conv_auto(
            ...
            conv_52_params.stride, 1, 1, conv_52_params.padding, conv_52_params.kernel_size, conv_52_params.kernel_size,
            false, false, false, false, false,
