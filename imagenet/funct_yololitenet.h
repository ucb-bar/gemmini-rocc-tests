...
#ifndef BAREMETAL
uint64_t* yololitenet_function(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_yololite){
#else
uint64_t* yololitenet_function(int cid, int orow_divide, int batch_divide, int target_util){
#endif
