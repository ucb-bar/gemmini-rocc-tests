...
void inception_3a_branch1(void* unused) {
    // conv_4
    if (!conv) {
        start = read_cycles();
...
void inception_3a_branch2 (void* unused) {
    // conv_5
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            256, conv_6_params.out_channels, -1, 0,
...
void inception_3a_branch3 (void* unused) {
    // conv_7
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            256, conv_8_params.out_channels, -1, 0,
...
void inception_3a_branch4 (void* unused) {
    // Branch 4
    // conv_10
    if (!conv) {
        start = read_cycles();
...
void inception_3b_branch1 (void* unused) {
    // Branch 1
    // conv_11
    if (!conv) {
        start = read_cycles();
...
void inception_3b_branch2 (void* unused) {
    // Branch 2
    // conv_12
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            480, conv_13_params.out_channels, -1, 0,
...
void inception_3b_branch3 (void* unused) {
    // Branch 3
    // conv_14
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            480, conv_15_params.out_channels, -1, 0,
...
void inception_3b_branch4 (void* unused) {
    // Branch 4
    // conv_17
    if (!conv) {
        start = read_cycles();
...
void inception_4a_branch1 (void* unused) {
    // Branch 1
    // conv_19
    if (!conv) {
        start = read_cycles();
...
void inception_4a_branch2 (void* unused) {
    // Branch 2
    // conv_20
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_21_params.out_channels, -1, 0,
...
void inception_4a_branch3 (void* unused) {
    // Branch 3
    // conv_22
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_23_params.out_channels, -1, 0,
...
void inception_4a_branch4 (void* unused) {
    // Branch 4
    // conv_25
    if (!conv) {
        start = read_cycles();
...
void inception_4b_branch1 (void* unused) {
    // Branch 1
    // conv_26
    if (!conv) {
        start = read_cycles();
...
void inception_4b_branch2 (void* unused) {
    // Branch 2
    // conv_27
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_28_params.out_channels, -1, 0,
...
void inception_4b_branch3 (void* unused) {
    // Branch 3
    // conv_29
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_30_params.out_channels, -1, 0,
...
void inception_4b_branch4 (void* unused) {
    // Branch 4
    // conv_32
    if (!conv) {
        start = read_cycles();
...
void inception_4c_branch1 (void* unused) {
    // Branch 1
    // conv_33
    if (!conv) {
        start = read_cycles();
...
void inception_4c_branch2 (void* unused) {
    // Branch 2
    // conv_34
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_35_params.out_channels, -1, 0,
...
void inception_4c_branch3 (void* unused) {
    // Branch 3
    // conv_36
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            512, conv_37_params.out_channels, -1, 0,
...
void inception_4c_branch4 (void* unused) {
    // Branch 4
    // conv_39
    if (!conv) {
        start = read_cycles();
...
void inception_4d_branch1 (void* unused) {
    // Branch 1
    // conv_40
    if (!conv) {
        start = read_cycles();
...
void inception_4d_branch2 (void* unused) {
    // Branch 2
    // conv_41
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            528, conv_42_params.out_channels, -1, 0,
...
void inception_4d_branch3 (void* unused) {
    // Branch 3
    // conv_43
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            528, conv_44_params.out_channels, -1, 0,
...
void inception_4d_branch4 (void* unused) {
    // Branch 4
    // conv_46
    if (!conv) {
        start = read_cycles();
...
void inception_4e_branch1 (void* unused) {
    // Branch 1
    // conv_47
    if (!conv) {
        start = read_cycles();
...
void inception_4e_branch2 (void* unused) {
    // Branch 2
    // conv_48
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            832, conv_49_params.out_channels, -1, 0,
...
void inception_4e_branch3 (void* unused) {
    // Branch 3
    // conv_50
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            832, conv_51_params.out_channels, -1, 0,
...
void inception_4e_branch4 (void* unused) {
    // Branch 4
    // conv_53
    if (!conv) {
        start = read_cycles();
...
void inception_5a_branch1 (void* unused) {
    // Branch 1
    // conv_55
    if (!conv) {
        start = read_cycles();
...
void inception_5a_branch2 (void* unused) {
    // Branch 2
    // conv_56
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            832, conv_57_params.out_channels, -1, 0,
...
void inception_5a_branch3 (void* unused) {
    // Branch 3
    // conv_58
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            832, conv_59_params.out_channels, -1, 0,
...
void inception_5a_branch4 (void* unused) {
    // Branch 4
    // conv_61
    if (!conv) {
        start = read_cycles();
...
void inception_5b_branch1 (void* unused) {
    // Branch 1
    // conv_62
    if (!conv) {
        start = read_cycles();
...
void inception_5b_branch2 (void* unused) {
    // Branch 2
    // conv_63
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            1024, conv_64_params.out_channels, -1, 0,
...
void inception_5b_branch3 (void* unused) {
    // Branch 3
    // conv_65
    if (!conv) {
        start = read_cycles();
    ...
    if (!conv) {
        ...
        tiled_conv_A_stride_auto(
            ...
            1024, conv_66_params.out_channels, -1, 0,
...
void inception_5b_branch4 (void* unused) {
    // Branch 4
    // conv_68
    if (!conv) {
        start = read_cycles();
...
void * thread_main() {
    ...
    // Inception 3a
    // Branch 1
    // inception_3a_branch1(NULL);
    SET_TASK(0, inception_3a_branch1, NULL);

    // Branch 2
    // inception_3a_branch2(NULL);
    SET_TASK(1, inception_3a_branch2, NULL);

    // Branch 3
    // inception_3a_branch3(NULL);
    SET_TASK(2, inception_3a_branch3, NULL);

    // Branch 4
    // inception_3a_branch4(NULL);
    SET_TASK(3, inception_3a_branch4, NULL);

    RUN_TASKS();

    // Inception 3b
    SET_TASK(0, inception_3b_branch1, NULL);
    SET_TASK(1, inception_3b_branch2, NULL);
    SET_TASK(2, inception_3b_branch3, NULL);
    SET_TASK(3, inception_3b_branch4, NULL);
    RUN_TASKS();

    // Inception 4a
    SET_TASK(0, inception_4a_branch1, NULL);
    SET_TASK(1, inception_4a_branch2, NULL);
    SET_TASK(2, inception_4a_branch3, NULL);
    SET_TASK(3, inception_4a_branch4, NULL);
    RUN_TASKS();

    // Inception 4b
    SET_TASK(0, inception_4b_branch1, NULL);
    SET_TASK(1, inception_4b_branch2, NULL);
    SET_TASK(2, inception_4b_branch3, NULL);
    SET_TASK(3, inception_4b_branch4, NULL);
    RUN_TASKS();

    // Inception 4c
    SET_TASK(0, inception_4c_branch1, NULL);
    SET_TASK(1, inception_4c_branch2, NULL);
    SET_TASK(2, inception_4c_branch3, NULL);
    SET_TASK(3, inception_4c_branch4, NULL);
    RUN_TASKS();

    // Inception 4d
    SET_TASK(0, inception_4d_branch1, NULL);
    SET_TASK(1, inception_4d_branch2, NULL);
    SET_TASK(2, inception_4d_branch3, NULL);
    SET_TASK(3, inception_4d_branch4, NULL);
    RUN_TASKS();

    // Inception 4e
    SET_TASK(0, inception_4e_branch1, NULL);
    SET_TASK(1, inception_4e_branch2, NULL);
    SET_TASK(2, inception_4e_branch3, NULL);
    SET_TASK(3, inception_4e_branch4, NULL);
    RUN_TASKS();

    // Inception 5a
    SET_TASK(0, inception_5a_branch1, NULL);
    SET_TASK(1, inception_5a_branch2, NULL);
    SET_TASK(2, inception_5a_branch3, NULL);
    SET_TASK(3, inception_5a_branch4, NULL);
    RUN_TASKS();

    // Inception 5b
    SET_TASK(0, inception_5b_branch1, NULL);
    SET_TASK(1, inception_5b_branch2, NULL);
    SET_TASK(2, inception_5b_branch3, NULL);
    SET_TASK(3, inception_5b_branch4, NULL);
    RUN_TASKS();
