...
#ifndef BAREMETAL
uint64_t* yololitenet_function_2(size_t cid, size_t group_id, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_yololite){
#else
uint64_t* yololitenet_function_2(size_t cid, size_t group_id, int orow_divide, int batch_divide, int target_util){
#endif
...
#define num_cycle (7+5+3)
  ...
  static uint64_t cycles[NUM_CORE][num_cycle];
    ...
    tiled_conv_A_stride_auto_stride(
        ...
        (elem_t*)image2_2, (elem_t*)conv_1_w_yololite2, (acc_t*)conv_1_b_yololite2, (elem_t*)conv_1_out_yololite2,
...
uint64_t* yololitenet_block_function_2(size_t cid, size_t group_id, int orow_divide, int batch_divide, int target_util){
#define num_cycle (7+5+3)
