...
void * thread_main() {
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_5_params.I, conv_5_params.J, conv_5_params.K,
            conv_5_params.J,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_7_params.I, conv_7_params.J, conv_7_params.K,
            conv_7_params.J,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_10_params.I, conv_10_params.J, conv_10_params.K,
            256,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_4_params.I, conv_4_params.J, conv_4_params.K,
            256,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_6_params.I, conv_6_params.J, conv_6_params.K,
            256,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_8_params.I, conv_8_params.J, conv_8_params.K,
            256,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_11_params.I, conv_11_params.J, conv_11_params.K,
            480,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_12_params.I, conv_12_params.J, conv_12_params.K,
            conv_12_params.J,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_14_params.I, conv_14_params.J, conv_14_params.K,
            conv_14_params.J,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_17_params.I, conv_17_params.J, conv_17_params.K,
            480,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_13_params.I, conv_13_params.J, conv_13_params.K,
            480,
    ...
    if (!conv) {
        ...
        matmul_extended_auto_norun(conv_15_params.I, conv_15_params.J, conv_15_params.K,
            480,
