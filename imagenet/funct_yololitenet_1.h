...
#ifndef BAREMETAL
uint64_t* yololitenet_function_1(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_yololite){
#else
uint64_t* yololitenet_function_1(int cid, int orow_divide, int batch_divide, int target_util){
#endif
...
#define num_cycle (7+5+3)
  ...
  static uint64_t cycles[num_proc][num_cycle];
    ...
    tiled_conv_A_stride_auto_stride(
        ...
        (elem_t*)images, (elem_t*)conv_1_w_yololite1, (acc_t*)conv_1_b_yololite1, (elem_t*)conv_1_out_yololite1,
...
uint64_t* yololitenet_block_function_1(int cid, int orow_divide, int batch_divide, int target_util){
#define num_cycle (7+5+3)
