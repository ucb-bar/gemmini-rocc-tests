...
#ifndef BAREMETAL
uint64_t* squeezenet_function_4(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_squeeze){
#else
uint64_t* squeezenet_function_4(int cid, int orow_divide, int batch_divide, int target_util){
#endif
...
#define num_cycle (26+1+3)
  ...
  static uint64_t cycles[num_proc][num_cycle];
    ...
    tiled_conv_A_stride_auto_cid(
        ...
        (elem_t*)images_4, (elem_t*)conv_1_w_squeeze4, (acc_t*)conv_1_b_squeeze4, (elem_t*)conv_1_out_squeeze4,
