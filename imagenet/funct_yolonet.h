...
#ifndef BAREMETAL
uint64_t* yolonet_function(int cid, int orow_divide, int batch_divide, int target_util, pthread_barrier_t  *barrier_yolo){
#else
uint64_t* yolonet_function(int cid, int orow_divide, int batch_divide, int target_util){
#endif
