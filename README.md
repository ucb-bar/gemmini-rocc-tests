...
Suppose you want to run with 5 cores.

1. Add `#define MULTITHREAD 5` to `riscv-tests/benchmarks/common/crt.S`.
1. Change `li a1, 1` to `li a1, 5` in `riscv-tests/benchmarks/common/crt.S`.
1. When running with Spike, use this command: `spike -p5 --extension=gemmini`.
