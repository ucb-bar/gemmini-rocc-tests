...
typedef struct args_tiled_conv_batch_parallel_auto_t {
...
} args_tiled_conv_batch_parallel_auto_t;

static void worker_tiled_conv_batch_parallel_auto(void * args_ptr) {
  args_tiled_conv_batch_parallel_auto_t * args = args_ptr;
...
static void tiled_conv_batch_parallel_auto(
  ...
  args_tiled_conv_batch_parallel_auto_t args[THREADS];
  ...
  for (int t = 0; t < THREADS; t++) {
    ...
    SET_TASK(t, worker_tiled_conv_batch_parallel_auto, &args[t]);
  }
  RUN_TASKS();
}
