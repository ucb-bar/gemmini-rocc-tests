...
static void sp_tiled_matmul_ws_At(const elem_t * A, const elem_t * B,
        const acc_t * D, elem_t * C,
        scale_t A_scale_factor, scale_t B_scale_factor, scale_acc_t D_scale_factor,
        size_t I, size_t J, size_t K, size_t pad_I, size_t pad_J, size_t pad_K,
        size_t A_row_stride, size_t B_row_stride, size_t D_row_stride, size_t C_row_stride,
  ...
  const int A_blocks = I <= MAX_BLOCK_LEN ? I : MAX_BLOCK_LEN;
  const int B_blocks = J <= MAX_BLOCK_LEN ? J : MAX_BLOCK_LEN;
  const int D_blocks = J <= MAX_BLOCK_LEN_ACC ? J : MAX_BLOCK_LEN_ACC;
...
static void sp_tiled_matmul_ws_Bt(const elem_t * A, const elem_t * B,
        const acc_t * D, elem_t * C,
        scale_t A_scale_factor, scale_t B_scale_factor, scale_acc_t D_scale_factor,
        size_t I, size_t J, size_t K, size_t pad_I, size_t pad_J, size_t pad_K,
        size_t A_row_stride, size_t B_row_stride, size_t D_row_stride, size_t C_row_stride,
...
static void tiled_matmul_outer(size_t dim_I, size_t dim_J, size_t dim_K,
  ...
  if (dataflow == OUTPUT_STATIONARY) {
    ...
    if (!a_transpose && !b_transpose) {
      ...
      inner = &sp_tiled_matmul_ws_At;
    } else /* if (!a_transpose && b_transpose) */ {
      inner = &sp_tiled_matmul_ws_Bt;
    }
  }
