...
#define INCREMENTAL_COUNTERS 46
...
#define RDMA_READ_REQUESTS 45
#define WDMA_WRITE_REQUESTS 46
...
#define SCRATCHPAD_READS (INCREMENTAL_COUNTERS + 8)
#define SCRATCHPAD_WRITES (INCREMENTAL_COUNTERS + 9)
#define ACCUMULATOR_READS (INCREMENTAL_COUNTERS + 10)
#define ACCUMULATOR_WRITES (INCREMENTAL_COUNTERS + 11)
