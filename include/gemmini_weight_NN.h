...
//    const int ocols = (pocols - 1) * pool_stride + pool_size - plpad - prpad;
	...
	gemmini_extended_config_ex(WEIGHT_STATIONARY, act, 0, shift, relu6_shift, ocols, row_turn, krows, stride, kchs, row_left, kdims, 0, 0); //if want 2 banks for weight, last is 1
...
void sp_tiled_conv_ws(
	...
	int act, int shift, int relu6_shift,
        bool no_bias, bool no_pool, bool no_1d,
	int double_bank, int triple_bank) {
