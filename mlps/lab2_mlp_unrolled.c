...
#define RAND rand()
    ...
    printf("==================================\n");
    printf("EE290-2 Lab2 Baseline Unrolled\n");
    printf("==================================\n");
    ...
    sp_tiled_matmul_layer0_ws(BATCH_SIZE, HIDDEN_SIZE, INPUT_SIZE,
            (elem_t*)input_mat, (elem_t*)weights0, NULL, (elem_t*) inter_results0, RELU);
    ...
    sp_tiled_matmul_layer1_ws(BATCH_SIZE, HIDDEN_SIZE, HIDDEN_SIZE,
            (elem_t*)inter_results0, (elem_t*)weights1, NULL, (elem_t*) inter_results1, RELU);
    ...
    sp_tiled_matmul_layer2_ws(BATCH_SIZE, OUTPUT_SIZE, HIDDEN_SIZE,
            (elem_t*)inter_results1, (elem_t*)weights2, NULL, (elem_t*) inter_results2, RELU);
