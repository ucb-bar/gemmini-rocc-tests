...
int main (int argc, char * argv[]) {
    ...
    */
    ...
    num_imgs = 128;
    elem_t C7[800][128] row_align(1) = {0};
    ...
    elem_t C8[800][256] row_align(1) = {0};
    ...
    num_imgs = 256;
    elem_t C9[800][256] row_align(1) = {0};
    ...
    elem_t C10[800][256] row_align(1) = {0};
    ...
    elem_t C11[224][256] row_align(1) = {0};
    ...
    // it should be 14*14 but it doesn't divide by 16
    elem_t C12[224][512] row_align(1) = {0};
    ...
    // it should be 14*14 but it doesn't divide by 16
    elem_t C13[224][512] row_align(1) = {0};
...
/* end of 5 repeated dw and 1x1 layers*/    
    ...
    elem_t C18[32][1024] row_align(1) = {0};
    pool7(1024,C17,C18);
    ...
    elem_t C19[32][1024] row_align(1) = {0};
