...
int main (int argc, char * argv[]) {
    ...
    //stride = 2
    static elem_t img[rgb][img_dim1][img_dim2] row_align(1) = {0};
    ...
    */
    ...
    num_imgs = 128;
    static elem_t C7[28*28][128] row_align(1) = {0};
    ...
    static elem_t C8[28*28][256] row_align(1) = {0};
    ...
    num_imgs = 256;
    static elem_t C9[28*28][256] row_align(1) = {0};
    ...
    static elem_t C10[28*28][256] row_align(1) = {0};
    ...
    static elem_t C11[13*16][256] row_align(1) = {0};
    ...
    // it should be 14*14 but it doesn't divide by 16
    static elem_t C12[13*16][512] row_align(1) = {0};
    ...
    // it should be 14*14 but it doesn't divide by 16
    static elem_t C13[13*16][512] row_align(1) = {0};
...
/* end of 5 repeated dw and 1x1 layers*/    
    ...
    static elem_t C18[16][1024] row_align(1) = {0};
    pool7(1024,C17,C18);
    ...
    static elem_t C19[16][1008] row_align(1) = {0};
