...
int main (int argc, char * argv[]) {
    ...
    tiled_matmul_compare(32, 800, 2528,    // dimensions
    ...
    tiled_matmul_compare(32, 2528, 2016,    // dimensions
    ...
    tiled_matmul_compare(32, 2016, 1504,    // dimensions
    ...
    tiled_matmul_compare(32, 1504, 1024,    // dimensions
    ...
    tiled_matmul_compare(32, 1024, 512,    // dimensions
    ...
    tiled_matmul_compare(32, 512, 32,    // dimensions
