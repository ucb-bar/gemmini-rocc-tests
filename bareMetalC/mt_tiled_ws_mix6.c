...
void thread_entry(int cid, int nc)
{
  ...
  //barrier(nc);
	 elem_t* A = (elem_t*) in_A0 + MAT_DIM_K*(MAT_DIM/2)*(cid/2);
	 elem_t* B = (elem_t*) in_B0 + ((MAT_DIM+64)/2)*(cid%2);
	 elem_t* C = (elem_t*) Out0 + ((MAT_DIM+64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
	 acc_t * D = (acc_t*) bias0 + ((MAT_DIM+64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
	size_t dim_j = (cid%2 == 0) ? (MAT_DIM+64)/2 : (MAT_DIM-64)/2;

  for(int j = 0; j < nc; j++){
		//printf("thread: %d, loop: %d \n", cid, j);
	if(j == cid){	
		 tiled_matmul_auto(MAT_DIM/2, dim_j, MAT_DIM, 
  ...
  B = (elem_t*) in_B1 + ((MAT_DIM-64)/2)*(cid%2);
  C = (elem_t*) Out1 + ((MAT_DIM-64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  D = (acc_t*) bias1 + ((MAT_DIM-64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  dim_j = (cid%2 == 1) ? (MAT_DIM+64)/2 : (MAT_DIM-64)/2;
  ...
  B = (elem_t*) in_B2 + ((MAT_DIM+64)/2)*(cid%2);
  C = (elem_t*) Out2 + ((MAT_DIM+64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  D = (acc_t*) bias2 + ((MAT_DIM+64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  dim_j = (cid%2 == 0) ? (MAT_DIM+64)/2 : (MAT_DIM-64)/2;
  ...
  B = (elem_t*) in_B3 + ((MAT_DIM-64)/2)*(cid%2);
  C = (elem_t*) Out3 + ((MAT_DIM-64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  D = (acc_t*) bias3 + ((MAT_DIM-64)/2)*(cid%2) + MAT_DIM_J*(MAT_DIM/2)*(cid/2);
  dim_j = (cid%2 == 1) ? (MAT_DIM+64)/2 : (MAT_DIM-64)/2;
