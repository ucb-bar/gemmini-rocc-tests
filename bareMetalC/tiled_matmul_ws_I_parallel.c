...
void full_matmul(elem_t A[MAT_DIM_I][MAT_DIM_K], elem_t B[MAT_DIM_K][MAT_DIM_J], ACC_T D[MAT_DIM_I][MAT_DIM_J], full_t C_full[MAT_DIM_I][MAT_DIM_J]) {
  for (size_t r = 0; r < MAT_DIM_I; r++)
    for (size_t c = 0; c < MAT_DIM_J; c++) {
      C_full[r][c] = REPEATING_BIAS ? D[0][c] : D[r][c];
...
void * thread_main() {
    ...
    static elem_t full_C[MAT_DIM_I][704+MAT_DIM_J] row_align(1);
...
#define RAND rand()
    ...
    // tiled_matmul_nn_auto_extended(MAT_DIM_I, MAT_DIM_J, MAT_DIM_K,
    tiled_matmul_nn_I_parallel_auto_extended(MAT_DIM_I, MAT_DIM_J, MAT_DIM_K,
            MAT_DIM_J,
            (elem_t*)full_A, (elem_t*)full_B, NO_BIAS ? NULL : &full_D[0][0], (elem_t*)full_C+704,
