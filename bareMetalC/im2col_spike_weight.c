...
#include <sys/mman.h>
#endif
#include "include/gemmini_testutils_weight.h"

#define out_tile 3 //0: batch, 1: out_dim 2: out_channel 3: greedy
#define weight_tile 2 //0: input_channel 1: out_channel 2: greedy
#define in_tile 3 //0: batch, 1: out_dim, 2: in_channel 3: greedy
#define weight_bank 1 //1~3
...
*/
    ...
    tiled_conv_auto(
        ...
        NO_ACTIVATION, 0, 0, 
	NO_1D ? 0 : POOL_SIZE, NO_POOL ? 0 : POOL_STRIDE, POOL_PADDING, WS,
	out_tile, weight_tile, in_tile, weight_bank);
