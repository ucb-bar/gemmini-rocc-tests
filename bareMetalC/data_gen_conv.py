...
print("static elem_t weight_mat[PATCH_SIZE][OUT_CHANNELS] row_align(MAX_BLOCK_LEN) = ", w_array)

print("static acc_t bias[OUT_CHANNELS] row_align(MAX_BLOCK_LEN_ACC) = ", D_array)

print("static elem_t input[IN_DIM][IN_DIM][IN_CHANNELS] row_align(MAX_BLOCK_LEN) = ", input_array)


print("static elem_t output[OUT_DIM][OUT_DIM][OUT_CHANNELS] row_align(MAX_BLOCK_LEN) = ", result_array)
