...
static elem_t in_A4[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B4[MAT_DIM_K][MAT_DIM_J] row_align(MAX_BLOCK_LEN) = {1};
static elem_t Out4[MAT_DIM_I][MAT_DIM_J] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_A5[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B5[MAT_DIM_K][MAT_DIM_J] row_align(MAX_BLOCK_LEN) = {1};
static elem_t Out5[MAT_DIM_I][MAT_DIM_J] row_align(MAX_BLOCK_LEN) = {1};
