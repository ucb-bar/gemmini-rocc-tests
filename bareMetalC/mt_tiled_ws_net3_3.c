...
#else
#define MAT_DIM_I (784/2) //4 batches
...
void thread_entry(int cid, int nc)
{
  ...
  for (int i = 0; i < nc; i++) {
	 ...
	 A = (cid == 0)? (elem_t*) Out0:(elem_t*) Out1;
	 B = (cid == 0)? (elem_t*) in_B01:(elem_t*) in_B11;
	 C = (cid == 0)? (elem_t*) Out01:(elem_t*) Out11;
	 D = (cid == 0) ? (ACC_T*) bias01:(ACC_T*) bias11;
	if(cid == 2){
		 A = (elem_t*) Out2;
		 B = (elem_t*) in_B21;
		 C = (elem_t*) Out21;
