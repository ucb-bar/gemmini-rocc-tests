...
#else
#define MAT_DIM_I 784 //1 batch
#define MAT_DIM_K 192
#define MAT_DIM_J 32 //layer 15 of mobilenet (small weight)
#endif
#define num_thread 4
#define A_TRANSPOSE 0
#define B_TRANSPOSE 0
...
static elem_t in_A0[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static elem_t in_B0[MAT_DIM_J][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//static elem_t full_C[MAT_DIM_I][MAT_DIM_J] row_align(1);
static ACC_T bias0[MAT_DIM_I][MAT_DIM_K] row_align_acc(MAX_BLOCK_LEN) = {1};
static elem_t Out0[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//Out0 is in_A1
//static elem_t in_A1[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B01[MAT_DIM_K][MAT_DIM_J] row_align(2) = {1};
static elem_t Out01[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static ACC_T bias01[MAT_DIM_I][MAT_DIM_J] row_align_acc(2) = {1};

static elem_t in_A1[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static elem_t in_B1[MAT_DIM_J][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//static elem_t full_C[MAT_DIM_I][MAT_DIM_J] row_align(1);
static ACC_T bias1[MAT_DIM_I][MAT_DIM_K] row_align_acc(MAX_BLOCK_LEN) = {1};
static elem_t Out1[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//Out0 is in_A1
//static elem_t in_A1[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B11[MAT_DIM_K][MAT_DIM_J] row_align(2) = {1};
static elem_t Out11[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static ACC_T bias11[MAT_DIM_I][MAT_DIM_J] row_align_acc(2) = {1};

static elem_t in_A2[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static elem_t in_B2[MAT_DIM_J][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//static elem_t full_C[MAT_DIM_I][MAT_DIM_J] row_align(1);
static ACC_T bias2[MAT_DIM_I][MAT_DIM_K] row_align_acc(MAX_BLOCK_LEN) = {1};
static elem_t Out2[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//Out0 is in_A1
//static elem_t in_A1[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B21[MAT_DIM_K][MAT_DIM_J] row_align(2) = {1};
static elem_t Out21[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static ACC_T bias21[MAT_DIM_I][MAT_DIM_J] row_align_acc(2) = {1};

static elem_t in_A3[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static elem_t in_B3[MAT_DIM_J][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
//static elem_t full_C[MAT_DIM_I][MAT_DIM_J] row_align(1);
...
//Out0 is in_A1
//static elem_t in_A1[MAT_DIM_I][MAT_DIM_K] row_align(MAX_BLOCK_LEN) = {1};
static elem_t in_B31[MAT_DIM_K][MAT_DIM_J] row_align(2) = {1};
static elem_t Out31[MAT_DIM_I][MAT_DIM_J] row_align(2) = {1};
static ACC_T bias31[MAT_DIM_I][MAT_DIM_J] row_align_acc(2) = {1};
